...
@Deprecated(
    message = "Use [View.isVisible] extension from core-ktx",
    replaceWith = ReplaceWith("View.isVisible")
)
 ...
 */
@Deprecated(
    message = "Use [View.drawToBitmap(config: Config)] extension from core-ktx",
    replaceWith = ReplaceWith("View.drawToBitmap()")
)
